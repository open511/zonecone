...
class myApplyForm extends sfGuardUserProfileForm
{
  ...
  public function configure()
  {
    ...
    unset($this['user_id'], $this['validate'], $this['fullname']);
    ...
    $this->widgetSchema->moveField('send_notification', sfWidgetFormSchema::LAST);
...
*/
    ...
    $this->setValidator('password', new sfValidatorString(array(
      ...
      'min_length' => 'That password is too short. It must contain a minimum of 1 characters.')));
 /*       
...
//\Steph - A voir si on veut implementer le prenom / nom pour les remplir dans SfGuardUser
    ...
    $this->fullname = $this->getValue('username');
...
//Steph
    $object->setFullname($this->fullname);
