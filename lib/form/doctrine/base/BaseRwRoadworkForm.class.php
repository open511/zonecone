...
abstract class BaseRwRoadworkForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_uncertain'    => new sfWidgetFormInputCheckbox(),
      'is_night'        => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'is_uncertain'    => new sfValidatorBoolean(array('required' => false)),
      'is_night'        => new sfValidatorBoolean(array('required' => false)),
